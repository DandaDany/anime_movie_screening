...
class SupplementalAtMoviesParserTests(unittest.TestCase):
    ...
    def test_stale_or_redirected_date_fails_closed(self):
        raw = """
        <html><body><h3>2026/09/12 (六)</h3>
        <div>劇場版 吉伊卡哇 人魚島的秘密</div><div>10：20</div><div>其他戲院(30)</div>
        </body></html>
        """.encode("utf-8")
        movies = [{"title": "劇場版 吉伊卡哇 人魚島的秘密", "aliases": []}]
    ...
    def test_alias_can_match_source_title(self):
        ...
        <div>電影哆啦A夢：新‧大雄的海底鬼岩城</div><div>08：30</div><div>其他戲院(5)</div>
        </body></html>
        """.encode("utf-8")
        movies = [{
            "title": "電影哆啦A夢：新．大雄的海底鬼岩城",
            "aliases": ["電影哆啦A夢：新‧大雄的海底鬼岩城"],
        }]
        parsed = parse_atmovies_page(raw, "2026-09-13", movies)
...
class SupplementalGeoJsonMergeTests(unittest.TestCase):
    def test_merge_does_not_delete_first_pass_showtimes(self):
        existing = {
            ...
            "properties": {
                "location_id": 68,
                "showtime_count": 1,
                "showtimes": [{"time": "10:00", "format": None, "language": None, "auditorium": None, "booking_url": "first", "label": "10:00"}],
                "start_times": "10:00",
            },
        }
        incoming = {
            ...
            "properties": {
                "location_id": 68,
                "chain_name": "美麗新影城",
                "location_name": "台北大直美麗新皇家影城",
                "map_name": "美麗新影城 台北大直美麗新皇家影城",
                "address": "x",
                "city": "臺北市",
                "location_url": "source",
                ...
                "showtime_count": 2,
                "showtimes": [
                    {"time": "10:00", "format": "電影", "language": None, "auditorium": None, "booking_url": "fallback", "label": "10:00 電影"},
                    {"time": "12:00", "format": "電影", "language": None, "auditorium": None, "booking_url": "fallback", "label": "12:00 電影"},
                ],
    ...
    def test_real_supplement_replaces_unavailable_placeholder(self):
        existing = {
            ...
            "properties": {
                ...
                "showtime_unavailable_reason": "blocked",
            },
        }
        incoming = {
            "type": "Feature",
            ...
            "properties": {
                ...
                "show_date": "2026-09-13",
                "showtime_count": 1,
                "showtimes": [{"time": "18:00", "format": None, "language": None, "auditorium": None, "booking_url": "fallback", "label": "18:00"}],
                "start_times": "18:00",
            },
        }
    ...
    def test_0600_promotes_today_from_yesterdays_future_bucket(self):
        ...
        old_feature = {
            "type": "Feature",
            "geometry": {"type": "Point", "coordinates": [121.0, 25.0]},
            "properties": {"location_id": 1, "showtime_count": 1, "showtimes": [{"time": "09:00"}]},
        }
        payload = {
            "movie_title": title,
            ...
            "movies": [],
            "movie_features": {},
            "movie_features_by_date": {title: {"2026-09-12": [], "2026-09-13": [old_feature]}},
            "available_dates": ["2026-09-12", "2026-09-13"],
            "features": [],
        }
        master = {
            "chains": [{"id": 1, "chain_name": "A", "official_url": None, "active": True}],
            "locations": [{"id": 1, "chain_id": 1, "location_name": "A", "display_name": None, "address": "x", "city": "台北市", "latitude": 25.0, "longitude": 121.0, "location_url": None, "active": True}],
        }
        merged, _, _ = merge_records_into_geojson(
            payload,
            primary_date="2026-09-13",
